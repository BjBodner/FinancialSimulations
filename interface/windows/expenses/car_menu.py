...
def car_menu():
    ...
    default_name = f"car{number}" # get this as input based on the number of vacations already available
    default_average_price = 80
    default_payed_down_payment = True
    default_starting_age_of_initial_car = 5
    default_average_car_lifetime = 7
    ...
    expense_dict["expense_params"]["average_car_price"] = default_average_price
    expense_dict["expense_params"]["payed_down_payment"] = default_payed_down_payment
    expense_dict["expense_params"]["starting_age_of_initial_car"] = default_starting_age_of_initial_car
    expense_dict["expense_params"]["average_car_lifetime"] = default_average_car_lifetime
    ...
    menu.add_selector("payed_down_payment : ", default=default_payed_down_payment, items=[("True",), ("False",)], onchange=process_payed_down_payment)
