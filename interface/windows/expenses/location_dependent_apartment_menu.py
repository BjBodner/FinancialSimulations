...
def location_dependent_apartment_menu():
    pygame.init()
    surface = pygame.display.set_mode(SURFACE_SIZE)

    menu = pygame_menu.Menu(MENU_SIZE[0], MENU_SIZE[1], "Location Dependent Apartment", theme=pygame_menu.themes.THEME_BLUE)
    ...
    expense_dict = {"name": "", "expense_params": {}, "expense_type": "LocationDependentApartment"}
...
if __name__ == "__main__":
    location_dependent_apartment_menu()