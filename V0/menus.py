...
class SimulationSettingsMenu:
    ...
    def __init__(self, name, global_config, config_file, main_menu_object):
        ...
        # default_invest_extra_earnings =  True
    ...
    def save_settings(self):
        ...
        # self.global_config["initial"]["expenses"][name] = copy.deepcopy(TEMPLATE_JOB)["template_job"] 
        # self.global_config["initial"]["expenses"][name]["jobs"]["main_job"] = {**self.job_dict["job_params"]}
...
class MainMenu:
    ...
    def __init__(self, surface, number=1, name=None, theme=pygame_menu.themes.THEME_BLUE, config_file=r"configs\dev_config.yaml"):
        ...
        # self.simulation_settings_menu = SimulationSettingsMenu("Simulation Settings", self.config, config_file, self) # for this just use a fixed expense type
